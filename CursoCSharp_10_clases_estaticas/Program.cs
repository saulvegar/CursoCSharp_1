...
namespace CursoCSharp_10_clases_estaticas {
    class Program {
        static void Main(string[] args) {
            ...
            var fibonacci8 = FibonacciNumberCalculator.GetFibonacciNumber(1); // 21
            var fibonacci2 = FibonacciNumberCalculator2.GetFibonacciNumber(2);
        }
    }
